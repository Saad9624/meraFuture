...
import { Text, View, TouchableOpacity,StyleSheet,Image,Modal,ScrollView,Dimensions,LogBox, Alert,BackHandler } from 'react-native'
        ...
        try {
         ...
         `https://merafuture.pk/api/home/getquestions?language=en&customer_id=${this.state.customer_id}&category_id=${this.state.testID}`, obj
          ...
          this.setState({
            ...
            questionImage:json.data[0].question_image
          })
      ...
      this.refs._scrollView.scrollTo(0);
        ...
        if(data.length-2 > value){
             ...
             this.setState({
                 ...
                 questionImage:data[value].question_image,
                 check1:false,
                 check2:false,
                 check3:false,
                 check4:false
 ...
 console.log("err2",err)
   ...
   {!this.state.loading &&  
    <TextView
      ...
      /> }
      {this.state.loading && 
                 <Shimmer style={{width:250,height:10,marginVertical:20,marginHorizontal:10}} intensity={0.5} >
          ...
          <TextView
            ...
            imageWidth={250}
            imageHeight={200}>
                <Image style={[AppStyles.largeImage3,{alignSelf:'center'}]}
