...
import { Text, View, TouchableOpacity,StyleSheet,Image ,FlatList,Modal, Alert,BackHandler} from 'react-native'
...
export class Instructions extends Component {
   ...
   async componentDidMount(){
    ...
    attemptTest= ()=>{
      if(this.state.allQuestions.length === this.state.allQuestionsId.length){
   ...
   return true;
    ...
    render() {
      return (
            ...
            <View style={{width:this.state.allQuestions.length ,alignSelf:'center',borderColor:'black',borderWidth:1,height:15}}>
                <View style={{width:this.state.allAnswers.length ,backgroundColor:colors.blue,height:13}}></View>
            </View>
